defmodule Ghost.PredictedFundingRates.DownloadChunksBroadway do
  use Broadway
  require Logger
  alias Broadway.Message
  alias Ghost.PredictedFundingRateChunks
  alias Ghost.PredictedFundingRateJobs
  ...
  def ack(:ack_id, successful, failed) do
    ...
    |> Enum.map(fn m ->
      ...
      PredictedFundingRateChunks.update(chunk, %{status: new_status})
