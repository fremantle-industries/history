defmodule History.Candles.DownloadChunksProducer do
  use GenStage
  alias History.CandleHistoryChunks
  ...
  defp handle_receive_messages(%_{receive_timer: nil, demand: demand} = state) when demand > 0 do
    chunks = CandleHistoryChunks.enqueued_after(state.last_chunk_id, demand)
