defmodule History.PredictedFundingRates.CreateChunksProducer do
  use GenStage
  alias History.PredictedFundingRateJobs
  ...
  defp handle_receive_messages(%_{receive_timer: nil, demand: demand} = state) when demand > 0 do
    jobs = PredictedFundingRateJobs.enqueued_after(state.last_job_id, demand)
