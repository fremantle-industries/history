defmodule History.PredictedFundingRates.DownloadChunksProducer do
  use GenStage
  alias History.PredictedFundingRateChunks
  ...
  defp handle_receive_messages(%_{receive_timer: nil, demand: demand} = state) when demand > 0 do
    chunks = PredictedFundingRateChunks.enqueued_after(state.last_chunk_id, demand)
