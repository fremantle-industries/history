defmodule GhostWeb.LendingRateJob.ShowLive do
  use GhostWeb, :live_view
  alias Ghost.{LendingRateHistoryJobs, LendingRateHistoryChunks}
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    Phoenix.PubSub.subscribe(Ghost.PubSub, "lending_rate_history_chunk:*")
