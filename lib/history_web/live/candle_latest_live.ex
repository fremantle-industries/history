defmodule HistoryWeb.CandleLatestLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      socket
      |> assign(:changeset, Candle.changeset(%Candle{}, %{}))
  ...
  @impl true
  def handle_event("delete", %{"candle-id" => id}, socket) do
    Candles.delete(id)
  ...
  defp assign_search(socket, query) do
    ...
    last_page = ceil(Candles.count(query: query) / socket.assigns.page_size)
